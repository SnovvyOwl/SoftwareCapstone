    ...
    setup(
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                ...
                module='PVRCNN.ops.roiaware_pool3d',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='PVRCNN.ops.roipoint_pool3d',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='PVRCNN.ops.pointnet2.pointnet2_stack',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='PVRCNN.ops.pointnet2.pointnet2_batch',
                sources=[
                    'src/pointnet2_api.cpp',
                    'src/ball_query.cpp',
                    'src/ball_query_gpu.cu',
