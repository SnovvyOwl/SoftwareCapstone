...
class NuscenesDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        split_dir = self.root_path / "v1.0-mini/nuscenes_infos_10sweeps"+self.split + '.pkl'
    ...
    def get_infos(self, raw_data_path, save_path, num_workers=multiprocessing.cpu_count(), has_label=True, sampled_interval=1):
        ...
        import waymo_utils
        print('---------------The nuscenes sample interval is %d, total sequecnes is %d-----------------'
    ...
    def get_lidar(self, sample_idx):
        lidar_file = self.data_path + ('%06d.npy' % sample_idx)
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        def waymo_eval(eval_det_annos, eval_gt_annos):
            from PVRCNN.datasets.waymo.waymo_eval import OpenPCDetWaymoDetectionMetricsEstimator
...
if __name__ == '__main__':
    ...
    if args.func == 'create_nuscencs_infos':
        import yaml
